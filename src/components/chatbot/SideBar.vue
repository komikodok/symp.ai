...
<template>
    <ul class="menu bg-base-200 gap-6 lg:gap-3 h-screen">
        <li class="tooltip tooltip-right" data-tip="Kembali">
            <a class="hover:bg-transparent" @mouseover="hoverStates[0] = true" @mouseleave="hoverStates[0] = false">
                <svg 
                    v-if="!hoverStates[0]"
                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-9 lg:size-6"
                >
                ...
                <svg 
                    v-if="hoverStates[0]"
                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-9 lg:size-6"
                >
